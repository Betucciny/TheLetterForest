...
import { Letter as LetterType, Word, getRandomLetters, getRandomWord } from '@/utils/data';
      ...
      <PaperProvider theme={paperTheme}>
        <NavigationContainer>
          <Stack.Navigator>
            ...
            <Stack.Screen name="Guessing" component={Guessing} options={{ headerShown: false }} initialParams={{ word: getRandomWord() }} />
